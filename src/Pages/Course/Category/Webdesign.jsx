...
import { webdesign } from '../../../Data/AllData'
          ...
          return <div key={id} className=' rounded-md relative pb-8 shadow-md'>
               ...
               <div className='m-5 leading-9'>
                 <div className='flex items-center justify-between'>
                    <p className={`${level === "Beginner" && ("text-[#0CBC87] bg-[#192E2C]")}} ${level === "All level" && ("text-violet-400 bg-[#232132]")} text-sm rounded p-1`}>{level}</p>
